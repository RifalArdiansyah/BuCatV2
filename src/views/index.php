...
<body id="page-top">
  ...
  $pengeluaran_hari_ini = $pengeluaran->totalByUserDate($id_user, "= CURDATE()")['total'];
  $pemasukan_hari_ini = $pemasukan->totalByUserDate($id_user, "= CURDATE()")['total'];

  $jumlahmasuk = $pemasukan->totalByUser($id_user)['total'];

  $jumlahkeluar = $pengeluaran->totalByUser($id_user)['total'];

  $uang = $jumlahmasuk - $jumlahkeluar;

  $pengeluaran_mingguan = $pengeluaran->totalByUserDate($id_user, "BETWEEN CURDATE() - INTERVAL 7 DAY AND CURDATE()")['total'];
  $pemasukan_mingguan = $pemasukan->totalByUserDate($id_user, "BETWEEN CURDATE() - INTERVAL 7 DAY AND CURDATE()")['total'];

  //untuk data chart area
  $sekarang = $pemasukan->totalByUserDate($id_user, "= CURDATE()")['total'];
  $satuhari = $pemasukan->totalByUserDate($id_user, "= CURDATE() - INTERVAL 1 DAY")['total'];
  $duahari = $pemasukan->totalByUserDate($id_user, "= CURDATE() - INTERVAL 2 DAY")['total'];
  $tigahari = $pemasukan->totalByUserDate($id_user, "= CURDATE() - INTERVAL 3 DAY")['total'];
  $empathari = $pemasukan->totalByUserDate($id_user, "= CURDATE() - INTERVAL 4 DAY")['total'];
  $limahari = $pemasukan->totalByUserDate($id_user, "= CURDATE() - INTERVAL 5 DAY")['total'];
  $enamhari = $pemasukan->totalByUserDate($id_user, "= CURDATE() - INTERVAL 6 DAY")['total'];
  $tujuhhari = $pemasukan->totalByUserDate($id_user, "= CURDATE() - INTERVAL 7 DAY")['total'];
  ?>
  <!-- Main Content -->
  <div id="content">
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-success shadow h-100 py-2">
            ...
            <?php
            echo number_format($pemasukan_mingguan ?? 0, 2, ',', '.');
            ?>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-danger shadow h-100 py-2">
            ...
            <?php
            echo number_format($pengeluaran_mingguan ?? 0, 2, ',', '.');
            ?>
          </div>
        </div>
